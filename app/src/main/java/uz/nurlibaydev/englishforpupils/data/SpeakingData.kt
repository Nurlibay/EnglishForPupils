...
object SpeakingData {
    ...
    fun getSpeakingScreenQuestions(unitNumber: Int): MutableList<HashMap<Int, String>> {
        ...
        when (unitNumber) {
            1 -> {
                firstQuestionVariants[0] = "I am good at drawing and cooking"
                firstQuestionVariants[1] = "In my free time, I watch movies on YouTube"//
                firstQuestionVariants[2] = "I usually go cycling once a week"
                firstQuestionVariants[3] = "I sometimes prefer being in the park"

                secondQuestionVariants[0] = "I prepare for my classes every day"
                ...
                secondQuestionVariants[3] = "I always study in the evening"//
            ...
            2 -> {
                firstQuestionVariants[0] = "I spent hours shopping every week"
                firstQuestionVariants[1] = "I do shopping at the weekends"
                firstQuestionVariants[2] = "I buy clothes in central supermarkets"//
                firstQuestionVariants[3] = "I do shopping because it is relaxing"

                secondQuestionVariants[0] = "My friends are good at fashion"
                ...
                secondQuestionVariants[3] = "My mother goes shopping together with me"//
            ...
            3 -> {
                firstQuestionVariants[0] = "I have enough time for entertainment"
                firstQuestionVariants[1] = "I always spent time with my groupmates"//
            ...
            4 -> {
                firstQuestionVariants[0] = "Swimming is a stress free sport"
                firstQuestionVariants[1] = "Basketball is easier than volleyball"
                firstQuestionVariants[2] = "Sport is an important activity"
                firstQuestionVariants[3] = "Football is a well-known sport"//

                secondQuestionVariants[0] = "It started late"
                secondQuestionVariants[1] = "We went to the cinema in the evening"
                secondQuestionVariants[2] = "It was amazing"//
            ...
            5 -> {
                firstQuestionVariants[0] = "I wrote a letter to my friend yesterday"
                firstQuestionVariants[1] = "I write it every other day"//
                firstQuestionVariants[2] = "I usually spend 10 minutes"
                firstQuestionVariants[3] = "I write it on my way home"

                secondQuestionVariants[0] = "Yes. I write every day"
                secondQuestionVariants[1] = "Yes. It is better than calling"
                secondQuestionVariants[2] = "No. It is replaced by sending messages."//
            ...
            6 -> {
                ...
                secondQuestionVariants[0] = "Yes, every evening"
                secondQuestionVariants[1] = "No, I can’t find"
                secondQuestionVariants[2] = "No, I always forget"
                secondQuestionVariants[3] = "Yes, all the time"//
            ...
            8 -> {
                firstQuestionVariants[0] = "I travel with my friends"
                firstQuestionVariants[1] = "I go Tashkent with my family"
                firstQuestionVariants[2] = "I travel twice a year"//
            ...
            9 -> {
                firstQuestionVariants[0] = "Because I feel relaxed"
                firstQuestionVariants[1] = "I go shopping every day"
                firstQuestionVariants[2] = "I prefer supermarkets"
                firstQuestionVariants[3] = "It is my favorite activity"//

                secondQuestionVariants[0] = "By public transport"
                secondQuestionVariants[1] = "To buy my needs"//
    ...
    fun getSpeakingScreenAnswers(unitNumber: Int): MutableList<Int> {
        when (unitNumber) {
            ...
            2 -> {
                return mutableListOf(2, 3)
            }
            3 -> {
                return mutableListOf(1, 0)
            }
            4 -> {
                return mutableListOf(3, 2)
            }
            5 -> {
                return mutableListOf(1, 2)
            }
            6 -> {
                return mutableListOf(0, 3)
            }
            7 -> {
                return mutableListOf(1, 3)
            }
